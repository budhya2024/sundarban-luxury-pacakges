...
export function FloatingActions() {
  ...
  return (
    <aside aria-label="Quick Actions" className="fixed bottom-6 right-5 sm:right-7 z-50 flex flex-col items-center gap-3 select-none">
      ...
      <a
        ...
        className="group relative flex h-12 w-12 sm:h-13 sm:w-13 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95"
      >
        {/* Subtle Pulse Ring */}
        <span
      ...
      <button
        ...
        className={`group relative flex h-11 w-11 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-[#78350f] hover:bg-[#d97706] text-white shadow-lg hover:shadow-2xl border border-white/20 transition-all duration-300 cursor-pointer ${
          showScrollTop
